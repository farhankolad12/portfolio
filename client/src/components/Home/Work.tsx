...
const PROJECTS = [
  {
    ...
    img: "/src/assets/multi-vendor.png",
  ...
  },
  {
    ...
    img: "/src/assets/farhanogram.png",
  ...
  },
  {
    ...
    img: "/src/assets/social-blend.png",
          ...
          return (
            ...
            >
              ...
              <div className="w-100 mt-3">
                <img
                  src={`http://127.0.0.1:5173/${project.img}`}
                  alt="img"
                  width="100%"
                  height="100%"
                />
